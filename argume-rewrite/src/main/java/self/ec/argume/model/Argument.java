...
public class Argument extends BaseEntity implements java.io.Serializable {
	...
	public String getAffirmativeInTurkish() {
		return affirmative ? Messages.getMessage("argument.affirmative.true")
				: Messages.getMessage("argument.affirmative.false");
	}
	...
	public static float magicScore(int likes, int dislikes) {
		return (likes - dislikes) + (2 * likes / MAGIC_NUMBER_LAMBDA)
				- (dislikes * MU);
	}
